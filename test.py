...
client = TestClient(nexrad_api.router)
client_goes=TestClient(goes_api.router)
...
def test_link_nexrad_streamlit():
    ...
    response = client.post(url="http://localhost:8000/nexrad_s3_fetchurl", json={'year': '2011', 'month': '10', 'day': '10', 'station': 'KBGM', 'file': 'KBGM20111010_000301_V03.gz'}, headers=headers)
    print(response.status_code)
    print(response.json())


test_link_nexrad_streamlit()
